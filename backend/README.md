...
```
json_path = "data/test/_annotations.coco.json"
...
```
python Personalize-SAM-main/persam_f.py --data data/Cups.v3i.coco-segmentation/test --outdir cups/persam --single true
```
